...
for val in df.columns[1:]:
    ...
    #     params = {'amplitude: {}'.format(amplitude_var._value().numpy())
    #               'length_scale: {}'.format(length_scale_var._value().numpy())
    #               'observation_noise_variance: {}'.format(observation_noise_variance_var._value().numpy())]}
    #     return params

    def write_trained_parameters():
        params = [amplitude_var._value().numpy(), length_scale_var._value().numpy(), observation_noise_variance_var._value().numpy()]
